...
from core.database.models import News, Entity, LinkedCompany, Topic
...
from core.nlp.entity_recognition_local import LocalFinanceNERExtractor  # Qwen3-4B local
...
from services.ceg.importance.impact import ImpactCalculator
from services.ceg.importance.covariance import CovarianceService
from services.ceg.events.ceg_realtime_service import CEGRealtimeService
...
class EnrichmentService:
    ...
    def _get_sector_for_ticker(self, ticker: str) -> Optional[str]:
        ...
        from services.aggregator.enrichment.moex_linker import MOEXSectorMapper
